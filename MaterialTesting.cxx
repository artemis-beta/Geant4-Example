...
int main(int argc, char** argv) {
    ...
    args::ValueFlag<std::filesystem::path> file_flag(parser, "config_file", "Read inputs from configuration file", {'f'});
    args::ValueFlag<G4String> phys_list_flag(parser, "physics_list", "Use specificed G4 Physics list", {'l'});
    args::ValueFlag<G4String> root_out_flag(parser, "output_file", "ROOT file to write results to", {'o'});
    args::ValueFlag<G4double> momentum_flag(parser, "momentum", "Momentum Z component in GeV", {'m'});
    args::ValueFlag<G4double> target_dz_flag(parser, "target_thickness", "Size of target in the Z axis in metres", {'t'});
    args::ValueFlag<G4double> gun_z_offset_flag(parser, "gun_z_offset", "Z axis position of particle fun in metres", {'z'});
